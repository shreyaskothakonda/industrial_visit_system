                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">            
                                            <h4 class="mt-0 header-title">Sent Requests</h4>         
                                            <table id="datatable-buttons" class="table table-striped table-bordered w-100">
                                                ...
                                                $get_requests_list = "SELECT * FROM `requests` WHERE `request_from_institute_id` = '$institute_id' " ; 
                                                $result = mysqli_query($con, $get_requests_list);
