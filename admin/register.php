                                        ...
                                        <div class="p-3">
                                            <form class="form-horizontal mb-0" action="functions/register_action.php" method="post">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <input class="form-control" type="text" required="" placeholder="Full Name" name="admin_name">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <input class="form-control" type="email" required="" placeholder="Email" name="admin_email">
                                                    </div>
                                                </div>
